...
source(here("hierarchical-models", "full-beta-binomial", "hierarchical-full-beta-binomial-jags.R"))
source(here("hierarchical-models", "full-beta-binomial", "hierarchical-full-beta-binomial-bugs.R"))
source(here("hierarchical-models", "full-beta-binomial", "hierarchical-full-beta-binomial-nimble.R"))
source(here("hierarchical-models", "full-beta-binomial", "hierarchical-full-beta-binomial-stan.R"))
source(here("hierarchical-models", "full-beta-binomial", "hierarchical-full-beta-binomial-greta.R"))
