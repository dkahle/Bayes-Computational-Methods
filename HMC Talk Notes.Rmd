...
- Might want to include Hamiltonian equations to explain kinetic and potential energy when then giving the visual illustration
- Potential energy is specified by the problem, but kinetic energy is not
- Good illustration might be the project up/down at 36:00 in video
