...
source(here("simple models", "regression-models","logistic-regression","logistic-regression-jags.R"))
source(here("simple models", "regression-models","logistic-regression","logistic-regression-bugs.R"))
source(here("simple models", "regression-models","logistic-regression","logistic-regression-nimble.R"))
source(here("simple models", "regression-models","logistic-regression","logistic-regression-stan.R"))
